...
namespace web_app.Controllers
{
    ...
    public class KeywordsController : ControllerBase
    {
        ...
        private readonly ExtraDatasetService _extraDatasetService;

        public KeywordsController(
            IKeywordService keywordService,
            WorldSeriesService worldSeriesService,
            ExtraDatasetService extraDatasetService
        )
        {
            _keywordService = keywordService;
            _worldSeriesService = worldSeriesService;
            _extraDatasetService = extraDatasetService;
        }
